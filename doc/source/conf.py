...
project = u'object_recognition_doc'
...
copyright = u'2013,  Willow Garage, Inc'
...
html_title = 'recognition kitchen ' #+ gittag_short
...
latex_documents = [
  ('index', 'ecto.tex', ur'ecto',
   ur'Troy D. Straszheim, Ethan A. Rublee, Vincent Rabaud, Gary Bradski', 'manual'),
]
